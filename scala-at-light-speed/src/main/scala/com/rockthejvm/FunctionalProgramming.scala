...
object FunctionalProgramming extends App {
  ...
  /*
    ...
    Conclusion: FunctionX = Function1, Function, ... Function22 -> 22 is MAX number of args that can be passed to a function
  */
  ...
  */
  ...
  val twoByTwo = aRange.map(x => 2 * x).toList // List(2,4,6,8...,1000)
